...
void S_Sound (int channel, FSoundID sfxid, float volume, float attenuation, float pitch = 1.0);
void S_Sound (AActor *ent, int channel, FSoundID sfxid, float volume, float attenuation, float pitch = 1.0);
void S_SoundMinMaxDist (AActor *ent, int channel, FSoundID sfxid, float volume, float mindist, float maxdist, float pitch = 1.0);
void S_Sound (const FPolyObj *poly, int channel, FSoundID sfxid, float volume, float attenuation, float pitch = 1.0);
void S_Sound (const sector_t *sec, int channel, FSoundID sfxid, float volume, float attenuation, float pitch = 1.0);
void S_Sound (fixed_t x, fixed_t y, fixed_t z, int channel, FSoundID sfxid, float volume, float attenuation, float pitch = 1.0);
